                ...
                <main className="flex-1 p-10 h-[calc(100vh-100px)] overflow-y-auto bg-white">
                    ...
                    <div>
                        {loading ? (
                            ...
                            <div className="text-center py-10 text-muted-foreground">Error fetching papers</div>
                        ) : viewMode === 'list' ? (
                                ...
                                <table className="min-w-full">
                                    ...
                                    <tbody>
                                        {papers.map((paper) => {
                                            ...
                                            if (status === 'draft') statusColor = 'bg-[rgba(106,156,220,0.4)] text-[#23406c]';
                                            if (status === 'review' || status === 'pending_review') statusColor = 'bg-[rgba(63,167,209,0.4)] text-[rgba(55,65,81,0.8)]';
                                            if (status === 'published' || status === 'approved') statusColor = 'bg-[rgba(47,202,161,0.4)] text-[rgba(55,65,81,0.8)]';
                                            return (
                                                ...
                                                >
                                                    <td className="px-4 py-4 font-medium text-gray-700 whitespace-nowrap max-w-xs truncate">
                                                        <div className="flex items-center">
                                                            <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-[#48B85C] text-white font-semibold text-xs mr-2">
                                                    ...
                                                    <td className="px-4 py-4 whitespace-nowrap text-center">
                                                        <span className={`inline-block px-2 py-1 rounded-full text-xs font-semibold capitalize mx-auto ${statusColor}`}>
                                                            {status.replace('_', ' ')}
                                                        </span>
                                                    </td>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                                {papers.map((paper) => (
                                    <DocumentCard key={paper._id} document={paper} />
                                ))}
                            </div>
                        ) : null}
                        {/* Pagination controls */}
