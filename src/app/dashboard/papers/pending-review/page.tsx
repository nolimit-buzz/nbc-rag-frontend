...
export default function AllPapersPage() {
    ...
    }, [searchTerm, selectedType, page, handleUnauthorized]);

    React.useEffect(() => {
        fetchPapers();
    }, [searchTerm, selectedType, page, fetchPapers]);
                        ...
                        >
                            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <h1 className="text-2xl font-bold text-gray-700">Pending Review</h1>
                                </div>
